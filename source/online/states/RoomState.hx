...
class RoomState extends MusicBeatState {
	...
	override function create() {
		...
		roomCode = new FlxText(0, 0, 0, "房间号: ????");
		roomCode.setFormat(Paths.font("chin.ttf"), 18, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		songName = new FlxText(0, 0, 0, "选择曲目: ????");
		songName.setFormat(Paths.font("chin.ttf"), 18, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		verifyMod.setFormat(Paths.font("chin.ttf"), 18, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		dlSkinTxt.setFormat(Paths.font("chin.ttf"), 18, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		itemTip.setFormat(Paths.font("chin.ttf"), 18, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    ...
    function updateTexts() {
		...
		songName.text = "选择的曲目 " + GameClient.room.state.song;
